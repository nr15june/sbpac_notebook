...
<div class="page-header mb-4">
    <h2 class="fw-bold mb-1">เพิ่มเครื่องปริ้น</h2>
    <p class="text-muted mb-0">กรอกข้อมูลเครื่องปริ้นเพื่อเพิ่มเข้าระบบ</p>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="status" class="form-select" required>
                        ...
                        <option value="borrowed" {{ old('status') == 'borrowed' ? 'selected' : '' }}>ถูกยืม</option>
                        <option value="broken" {{ old('status') == 'broken' ? 'selected' : '' }}>เสีย/ซ่อม</option>
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text"
                        ...
                        class="form-control"
                        value="{{ old('model') }}"
                        placeholder="เช่น LaserJet Pro">
                </div>

                <div class="col-12">
                    <label class="form-label fw-semibold">หมายเหตุ</label>
                    <textarea name="note" class="form-control" rows="3" placeholder="รายละเอียดเพิ่มเติม...">{{ old('note') }}</textarea>
                </div>
